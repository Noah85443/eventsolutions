    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <p>Artikelnr:
                    <?php print $artikel->artikelnummer; ?>
                </p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-4">
                ...
                <span style="color:#71AF4F;">&euro;
                    <?php print number_format($artikel->prijs, 2, ',', '.'); ?>
                </span>
                /
                <?php print $artikel->stuksPerEenheid; ?> stuk(s)
                <br />
                extra huurdag: &euro;
                <?php print number_format(($artikel->prijs * (1 * $shopData['huurFactor'])), 2, ',', '.'); ?>
                <br /><br />
                <?php echo $artikel->artikelsoort; ?> (inclusief BTW):<br />
                <?php $btw = '1.' . $artikel->btwTarief; ?>
                &euro;
                <?php print number_format($artikel->prijs * $btw, 2, ',', '.'); ?>
                /
                <?php print $artikel->stuksPerEenheid; ?> stuk(s)
                <br />
                extra huurdag: &euro;
        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                if (!empty($artikel->kenmerken)) {
                    print "<table>";
                    foreach ($kenmerken as $kenmerk => $waarde) {
