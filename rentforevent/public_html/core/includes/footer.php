      ...
      <div class="row">
        ...
        <div class="col-5 col-md-3 mb-3">
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2"><a href="/algemene-info/" class="nav-link p-0 text-muted">Privacyverklaring</a>
            </li>
          </ul>
        </div>
        <div class="col-5 col-md-3 mb-3">
          <h5>Social</h5>
          <ul class="nav flex-column">
            <li class="nav-item mb-2"><a href="https://facebook.com/eventsolutions.nu" target="_blank"
                class="nav-link p-0 text-muted">Volg ons op facebook</a></li>
            <li class="nav-item mb-2"><a href="https://instagram.com/eventsolutions_nl" target="_blank"
                class="nav-link p-0 text-muted">Volg ons op instagram</a></li>
            <li class="nav-item mb-2"><a href="https://wa.me/31262022943" target="_blank"
                class="nav-link p-0 text-muted">WhatsApp ons</a></li>
          </ul>
        </div>
