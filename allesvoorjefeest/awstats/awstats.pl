...
sub Read_Config {
	...
	# Standard, Mandrake and Debian package :	"/home/u10448d24532/domains/allesvoorjefeest.nl/awstats/.data"
	# Other possible directories :				"/usr/local/etc/awstats", "/etc"
	# FHS standard, Suse package : 				"/etc/opt/awstats"
	my $configdir         = shift;
	my @PossibleConfigDir = (
			"$DIR",
			"/home/u10448d24532/domains/allesvoorjefeest.nl/awstats/.data",
