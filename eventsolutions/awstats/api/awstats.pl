...
sub Read_Config {
	...
	# Standard, Mandrake and Debian package :	"/home/u10448d24532/domains/eventsolutions.nu/awstats/api/.data"
	# Other possible directories :				"/usr/local/etc/awstats", "/etc"
	# FHS standard, Suse package : 				"/etc/opt/awstats"
	my $configdir         = shift;
	my @PossibleConfigDir = (
			"$DIR",
			"/home/u10448d24532/domains/eventsolutions.nu/awstats/api/.data",
